...
<head runat="server">
    ...
    <link rel="stylesheet" media="screen" href="style.css?v=13" />
...
<body>
                    ...
                    <div id="player">
                        <form class="jsqari-interface">
                            ...
                            <div>
		                        ...
		                        <label for="jsqari-ui-mode-selector">Mode</label>
		                        <select id="jsqari-ui-mode-selector" class="medium">
			                        <option value="continious">Continous</option>
    ...
    <script type="text/javascript" src="/scripts/jsqari/jquery.jplayer.min.js"></script>
	<script type="text/javascript" src="/scripts/jsqari/jsqari.js"></script>
